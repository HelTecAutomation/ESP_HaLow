...
#define CONFIG_MM_RESET_N 9 
#define CONFIG_MM_WAKE 8
#define CONFIG_MM_BUSY 1
#define CONFIG_MM_SPI_SCK 11
#define CONFIG_MM_SPI_MOSI 12
#define CONFIG_MM_SPI_MISO 13
#define CONFIG_MM_SPI_CS 10
#define CONFIG_MM_SPI_IRQ 14

#define HALOW_LDO_CTRL   3
#define HALOW_LDO_ENABLE HIGH
