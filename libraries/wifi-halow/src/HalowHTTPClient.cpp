...
public:
    ...
    virtual std::unique_ptr<HalowClient> create()
    {
        return std::unique_ptr<HalowClient>(new HalowClient());
    }

    virtual bool verify(HalowClient& client, const char* host)
    {
        return true;
    }
};
...
public:
    ...
    std::unique_ptr<HalowClient> create() override
    {
        return std::unique_ptr<HalowClient>(new HalowClientSecure());
    }

    bool verify(HalowClient& client, const char* host) override
    {
        HalowClientSecure& wcs = static_cast<HalowClientSecure&>(client);
        if (_cacert == nullptr) {
            wcs.setInsecure();
        } else {
 ...
 * constructor
 */
HalowHTTPClient::HalowHTTPClient()
{
}
 ...
 * @return success bool
 */
bool HalowHTTPClient::begin(HalowClient &client, String url) {
#ifdef HTTPCLIENT_1_1_COMPATIBLE
    if(_tcpDeprecated) {
 ...
 * @return success bool
 */
bool HalowHTTPClient::begin(HalowClient &client, String host, uint16_t port, String uri, bool https)
{
#ifdef HTTPCLIENT_1_1_COMPATIBLE
    if(_tcpDeprecated) {
        log_d("mix up of new and deprecated api");
...
#ifdef HTTPCLIENT_1_1_COMPATIBLE
bool HalowHTTPClient::begin(String url, const char* CAcert)
{
 ...
 * @param url String
 */
bool HalowHTTPClient::begin(String url)
{
    if(_client && !_tcpDeprecated) {
        log_d("mix up of new and deprecated api");
        _canReuse = false;
...
bool HalowHTTPClient::beginInternal(String url, const char* expectedProtocol)
{
...
#ifdef HTTPCLIENT_1_1_COMPATIBLE
bool HalowHTTPClient::begin(String host, uint16_t port, String uri)
{
    if(_client && !_tcpDeprecated) {
        log_d("mix up of new and deprecated api");
        _canReuse = false;
...
bool HalowHTTPClient::begin(String host, uint16_t port, String uri, const char* CAcert)
{
    if(_client && !_tcpDeprecated) {
        log_d("mix up of new and deprecated api");
        _canReuse = false;
...
bool HalowHTTPClient::begin(String host, uint16_t port, String uri, const char* CAcert, const char* cli_cert, const char* cli_key)
{
    if(_client && !_tcpDeprecated) {
        log_d("mix up of new and deprecated api");
        _canReuse = false;
 ...
 */
void HalowHTTPClient::disconnect(bool preserveClient)
{
    if(connected()) {
 ...
 */
bool HalowHTTPClient::connected()
{
    if(_client) {
 ...
 * @param reuse bool
 */
void HalowHTTPClient::setReuse(bool reuse)
{
    _reuse = reuse;
}
 ...
 */
void HalowHTTPClient::setUserAgent(const String& userAgent)
{
 ...
 */
void HalowHTTPClient::setAuthorization(const char * user, const char * password)
{
    if(user && password) {
        String auth = user;
        auth += ":";
 ...
 */
void HalowHTTPClient::setAuthorization(const char * auth)
{
    if(auth) {
 ...
 */
void HalowHTTPClient::setAuthorizationType(const char * authType)
{
    if(authType) {
 ...
 */
void HalowHTTPClient::setConnectTimeout(int32_t connectTimeout)
{
 ...
 */
void HalowHTTPClient::setTimeout(uint16_t timeout)
{
    _tcpTimeout = timeout;
    if(connected()) {
 ...
 * @param use
 */
void HalowHTTPClient::useHTTP10(bool useHTTP10)
{
 ...
 * @return http code
 */
int HalowHTTPClient::POST(uint8_t * payload, size_t size)
{
    return sendRequest("POST", payload, size);
}

int HalowHTTPClient::POST(String payload)
{
 ...
 * @return http code
 */
int HalowHTTPClient::PATCH(uint8_t * payload, size_t size)
{
    return sendRequest("PATCH", payload, size);
}

int HalowHTTPClient::PATCH(String payload)
{
 ...
 * @return http code
 */
int HalowHTTPClient::PUT(uint8_t * payload, size_t size) {
    return sendRequest("PUT", payload, size);
}

int HalowHTTPClient::PUT(String payload) {
 ...
 * @return
 */
int HalowHTTPClient::sendRequest(const char * type, String payload)
{
 ...
 */
int HalowHTTPClient::sendRequest(const char * type, uint8_t * payload, size_t size)
{
    int code;
    bool redirect = false;
 ...
 * @return -1 if no info or > 0 when Content-Length is set by server
 */
int HalowHTTPClient::sendRequest(const char * type, Stream * stream, size_t size)
{
 ...
 * @return -1 if no info or > 0 when Content-Length is set by server
 */
int HalowHTTPClient::getSize(void)
{
    return _size;
}
 ...
 * @return HalowClient
 */
HalowClient& HalowHTTPClient::getStream(void)
{
    if (connected()) {
        return *_client;
    }
 ...
 * @return HalowClient*
 */
HalowClient* HalowHTTPClient::getStreamPtr(void)
{
    if(connected()) {
        return _client;
    }
 ...
 */
int HalowHTTPClient::writeToStream(Stream * stream)
{
 ...
 * @return String
 */
String HalowHTTPClient::getString(void)
{
 ...
 * @return String
 */
String HalowHTTPClient::errorToString(int error)
{
    switch(error) {
 ...
 * @param first
 */
void HalowHTTPClient::addHeader(const String& name, const String& value, bool first, bool replace)
{
...
void HalowHTTPClient::collectHeaders(const char* headerKeys[], const size_t headerKeysCount)
{
...
String HalowHTTPClient::header(const char* name)
{
    for(size_t i = 0; i < _headerKeysCount; ++i) {
...
String HalowHTTPClient::header(size_t i)
{
...
String HalowHTTPClient::headerName(size_t i)
{
    if(i < _headerKeysCount) {
...
int HalowHTTPClient::headers()
{
    return _headerKeysCount;
}

bool HalowHTTPClient::hasHeader(const char* name)
{
    for(size_t i = 0; i < _headerKeysCount; ++i) {
 ...
 */
bool HalowHTTPClient::connect(void)
{
    if(connected()) {
        if(_reuse) {
    ...
    if (!_client) {
        log_d("HalowHTTPClient::begin was not called or returned error");
        return false;
    }
#ifdef HTTPCLIENT_1_1_COMPATIBLE
    ...
    // set Timeout for HalowClient and for Stream::readBytesUntil() and Stream::readStringUntil()
 ...
 * @return status
 */
bool HalowHTTPClient::sendHeader(const char * type)
{
    if(!connected()) {
        return false;
    }
 ...
 */
int HalowHTTPClient::handleHeaderResponse()
{
 ...
 */
int HalowHTTPClient::writeToStreamDataBlock(Stream * stream, int size)
{
 ...
 * @return error
 */
int HalowHTTPClient::returnError(int error)
{
    if(error < 0) {
...
void HalowHTTPClient::setFollowRedirects(followRedirects_t follow)
{
    _followRedirects = follow;
}

void HalowHTTPClient::setRedirectLimit(uint16_t limit)
{
 ...
 * @param url
 */
bool HalowHTTPClient::setURL(const String& url)
{
...
const String &HalowHTTPClient::getLocation(void)
{
    return _location;
}

void HalowHTTPClient::setCookieJar(CookieJar* cookieJar)
{
    _cookieJar = cookieJar;
}

void HalowHTTPClient::resetCookieJar()
{
    _cookieJar = nullptr;
}

void HalowHTTPClient::clearAllCookies()
{
    if (_cookieJar) _cookieJar->clear();
}

void HalowHTTPClient::setCookie(String date, String headerValue)
{
    if (!_cookieJar)
    {
        return;
...
bool HalowHTTPClient::generateCookieString(String *cookieString)
{
    time_t now_local = time(NULL);
    time_t now_gmt = mktime(gmtime(&now_local));
