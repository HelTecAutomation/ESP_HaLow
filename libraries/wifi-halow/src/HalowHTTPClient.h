 ...
 * This file is part of the HalowHTTPClient for Arduino.
...
#ifndef HalowHTTPClient_H_
#define HalowHTTPClient_H_
 ...
 * ensure the client object lives the entire time of the HalowHTTPClient
 */
    bool begin(HalowClient &client, String url);
    bool begin(HalowClient &client, String host, uint16_t port, String uri = "/", bool https = false);
    ...
    HalowClient& getStream(void);
    HalowClient* getStreamPtr(void);
...
protected:
    ...
    std::unique_ptr<HalowClient> _tcpDeprecated;
#endif

    HalowClient* _client = nullptr;
